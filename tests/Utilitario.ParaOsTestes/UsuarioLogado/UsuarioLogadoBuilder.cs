...
namespace UtilitarioParaOsTestes.UsuarioLogado;
public class UsuarioLogadoBuilder
{
	...
	{
		if (_repositorio == null) _repositorio = new Mock<IUsuarioLogado>();
	}
	...
	public UsuarioLogadoBuilder RecuperarUsuario(LivroReceitas.Domain.Entidades.Usuario usuario)
	{
