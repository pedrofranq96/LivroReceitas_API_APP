...
public class RecuperarTodasAsConexoesUseCaseTeste
{
	[Theory]
	[InlineData(1)]
	[InlineData(2)]
		...
		int quantidadeReceitas)
	{
		...
		return new RecuperarTodasConexoesUseCase(usuarioLogado, repositorioReceita, repositorioConexao, autoMapper);
	}
}
