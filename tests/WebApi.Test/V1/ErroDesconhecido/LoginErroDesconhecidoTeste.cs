...
public class LoginErroDesconhecidoTeste : IClassFixture<LivroReceitasWebApplicationFactorySemIdLogin<Program>>
{
	...
	{
		var requisicao = new LivroReceitas.Comunicacao.Requesicoes.RequisicaoLoginJson();
