...
public class AtualizarReceitaValidatorTeste
{
	[Fact]
	...
	public void Validar_Erro_Ingrediente_Repetido()
	{
		...
		resultado.IsValid.Should().BeFalse();
		resultado.Errors.Should().ContainSingle().And.Contain(error => error.ErrorMessage.Equals(ResourceMensagensDeErro.RECEITA_INGREDIENTE_REPETIDO));
	}
}
